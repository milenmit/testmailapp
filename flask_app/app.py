...
# Get the LOAD_UI value from the environment
load_ui = os.getenv('LOAD_UI', 'True').lower() == 'true'
print(f"LOAD_UI is set to: {load_ui}")  # This will print True or False based on the .env value
...
def index():
    if load_ui:
        ...
        return jsonify({"message": "UI is disabled"}), 403
